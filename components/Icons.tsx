...
export const SceneIcon = ({ className }: { className?: string }) => (
...
export const GlobeIcon = ({ className, title, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-4 w-4"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" {...props}>
        {title && <title>{title}</title>}
...
export const TextureIcon = (props: IconProps) => (
